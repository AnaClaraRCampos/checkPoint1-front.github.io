window.onload = function() {
    // Prevenir formulario de ser enviado
        ...
        form.addEventListener('submit', function(event) {
            ...
            imagem.classList.add('serie-imagem');
            // Element h2   - Título
            ...
            conteudo.classList.add('serie-item-conteudo');
            ...
            item.classList.add('serie-item');
            item.appendChild(imagem);
            item.appendChild(conteudo);
            
            // Pegar o Card e inserir na Lista de Séries
            const lista = document.querySelector('.serie-lista');
